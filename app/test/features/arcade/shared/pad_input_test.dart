// `PadKeyboardMirror`'s own rules (`PLAN-phase-4.md` §4.6): arrows or A/D
// hold left/right, space holds fire, two directions can be held together, an
// unmapped key is ignored, and the first key it handles hides the pad.
//
